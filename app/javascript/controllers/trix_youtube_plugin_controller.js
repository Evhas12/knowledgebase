...
export default class extends Controller {
  connect() {
    console.log("trix-youtube-plugin controller is connected now")
    this.addTrixButton()
    this.addTrixDialog()
  ...
  addTrixButton() {
    ...
    const buttonGroup = this.element.toolbarElement.querySelector(".trix-button-group--file-tools")
  ...
  addTrixDialog() {
    const dialogHTML = `<div class="trix-dialog trix-dialog--link" data-trix-dialog="embed" data-trix-dialog-attribute="embed">
                          <div class="trix-dialog__link-fields">
                            <input type="text" name="embed" class="trix-input trix-input--dialog" placeholder="Paste your URL - Youtube, Vimeo, & Wistia" aria-label="embed code" required="" data-trix-input="" disabled="disabled">
